-- ============================================================
--  EduCore — Script de migración MySQL → PostgreSQL (Supabase)
...
-- Roles iniciales
INSERT INTO rol (nombreRol) VALUES ('Director'), ('Secretaria'), ('Docente')
...
CREATE TABLE IF NOT EXISTS calificacioncurso (
    ...
    UNIQUE (idMatricula, idCompetenciaCurso, idBimestre)
);
...
CREATE TABLE IF NOT EXISTS calificaciontransversal (
    ...
    idBimestre               INT            NOT NULL REFERENCES bimestre(idBimestre),
    nota                     NUMERIC(5, 2),
    UNIQUE (idMatricula, idCompetenciaTransversal, idBimestre)
);
...
-- o usar el Table Editor de Supabase para importar CSV.
